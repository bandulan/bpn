            ...
            <div class="col-md-3">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h4 class="text-center">Data Pemilik</h4>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <strong><i class="far fa-file-alt mr-1"></i> Tempat Lahir</strong>
            ...
            <div class="col-md-9">
                ...
                <div class="col">
                    <div class="card card-outline card-success">
                        ...
                        <img class="card-img-top" src="https://via.placeholder.com/1000x300" alt="Card image cap" height="300px">
                        <div class="card-body">
